...
@app.route("/api/first_macd_data_apple") 
...
@app.route("/api/first_rsi_data_apple") 
def query_apple_rsi_data():
...
@app.route("/api/first_macd_data_google") 
def query_google_macd_data():
...
@app.route("/api/first_rsi_data_google") 
def query_google_rsi_data():
...
@app.route("/api/first_stoch_data_google") 
def query_google_stoch_data():
...
@app.route("/api/first_macd_data_tesla") 
def query_tesla_macd_data():
...
@app.route("/api/first_rsi_data_tesla") 
def query_tesla_rsi_data():
...
@app.route("/api/first_stoch_data_tesla") 
def query_tesla_stoch_data():
